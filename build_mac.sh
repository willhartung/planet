...
jpackage --type dmg --dest target/installer --input target/installer/input/libs/ --icon icons/planet.icns --name Planet --main-class bit.planet.Launcher --main-jar Planet-1.0-SNAPSHOT.jar --runtime-image target/java-runtime
